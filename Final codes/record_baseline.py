...
import pylsl
import pyxdf
from pylsl import resolve_stream, StreamInlet, resolve_byprop
import mne
...
raw.save(r"C:\Users\varsh\OneDrive\Desktop\NFB-MNE-Psy\baseline-raw.fif", overwrite=True)
